...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(AsapAuthUser newUser) {
    final shouldUpdate =
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'dashboard2',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'dashboard2')
            ...
            FFRoute(
              ...
              path: 'peminjaman',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'Peminjaman')
                  : PeminjamanWidget(
                      jumlah: params.getParam<int>(
                        'jumlah',
                        ParamType.int,
                        isList: true,
                      ),
