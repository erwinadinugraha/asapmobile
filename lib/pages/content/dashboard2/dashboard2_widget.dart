...
class _Dashboard2WidgetState extends State<Dashboard2Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'dashboard2'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('DASHBOARD2_PAGE_dashboard2_ON_INIT_STATE');
      if (!loggedIn) {
        logFirebaseEvent('dashboard2_navigate_to');
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'SPT Masa PPh PT.Nusa Indah Jaya 2014',
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
                                            fontFamily: 'Inter',
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(0.0, 4.0, 0.0, 0.0),
                                              child: Text(
                                                'Kapasitas peserta maksimal 10 peserta',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
